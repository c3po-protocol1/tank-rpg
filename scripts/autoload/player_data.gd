...
## Persistent player data: level, XP, stats, class, and upgrades.
...
# Bonus stats from manual upgrades (on top of base + growth)
...
# Current HP/SP (combat state, reset each stage)
